...
oc_problems = [el.strip() for el in oc_problems]
...
for setting in presets:
    # get the current algorithmic settings
    exact_hessian = setting[0]
    always_auto = setting[1]
    auto_condense = setting[2]
