...
class problem(BaseOCClass.super_problem):
    ...
    def __init__(self, criterion="A"):
        ...
        self.control_labels = [r"$u_{" + str(i) + "}$" for i in range(1)]
    ...
    def get_ode(self):
        ...
        p_fix = cs.DM([4.e3, 6.2e5, -2.5e3, -5.e3])
    ...
    def get_init(self):
        ...
        init["q_start"] = [300] + [0.5] * (self.q_dim - 1)
    ...
    def control_bounds(self, control):
        lbu = [298.] + [0.] * (self.q_dim - 1)
        ubu = [398.] + [1.] * (self.q_dim - 1)
